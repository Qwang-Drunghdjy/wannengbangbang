...
@WebMvcTest(FindItemController.class)
class FindItemControllerTest {
    ...
    void getById_shouldReturnItem() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/find-items/1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.code").value(200))
    ...
    void getById_shouldReturnErrorWhenNotFound() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/find-items/999"))
                .andExpect(status().isOk())
